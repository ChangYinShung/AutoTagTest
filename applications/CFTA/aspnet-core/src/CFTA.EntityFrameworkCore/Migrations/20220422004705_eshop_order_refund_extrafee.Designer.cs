...
namespace CFTA.Migrations
{
    ...
    [Migration("20220422004705_eshop_order_refund_extrafee")]
    partial class eshop_order_refund_extrafee
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FS.Abp.Emailing.MailMessageTemplate", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("Id");
                    ...
                    b.ToTable("AbpMailMessageTemplates", (string)null);
                });

            modelBuilder.Entity("FS.CmsKit.ContentComposites.ContentComponent", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("Id");
                    ...
                    b.Property<string>("ContentComponentDiscriminator")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("ContentComponentDiscriminator");

                    b.Property<Guid?>("ContentEntityId")
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("ContentEntityId");
                    ...
                    b.ToTable("CmsKitContentComponents", (string)null);

                    b.HasDiscriminator<string>("Discriminator").HasValue("ContentComponent");
                });

            modelBuilder.Entity("FS.CmsKit.ContentDefinitions.ContentDefinition", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("Id");
            ...
            modelBuilder.Entity("FS.CmsKit.ContentDefinitions.ContentPartDefinition", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("Id");
                    ...
                    b.Property<string>("TemplateDefinitionName")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("TemplateDefinitionName");
                    ...
                    b.ToTable("CmsKitContentPartDefinitions", (string)null);
                });

            modelBuilder.Entity("FS.CmsKit.ContentDefinitions.ContentPartFieldDefinition", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("Id");

                    b.Property<Guid>("ContentPartDefinitionId")
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("ContentPartDefinitionId");
                    ...
                    b.HasIndex("ContentPartDefinitionId");

                    b.ToTable("CmsKitContentPartFieldDefinitions", (string)null);
                });

            modelBuilder.Entity("FS.CmsKit.ContentDefinitions.ContentTypeDefinition", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("Id");
                    ...
                    b.ToTable("CmsKitContentTypeDefinitions", (string)null);
                });

            modelBuilder.Entity("FS.CmsKit.ContentDefinitions.ContentTypePartDefinition", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("Id");
                    ...
                    b.Property<Guid>("ContentTypeDefinitionId")
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("ContentTypeDefinitionId");
                    ...
                    b.ToTable("CmsKitContentTypePartDefinitions", (string)null);
                });

            modelBuilder.Entity("FS.CmsKit.ContentEntities.ContentEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("Id");
                    ...
                    b.ToTable("CmsKitContentEntities", (string)null);
                });

            modelBuilder.Entity("FS.CmsKit.EntityMedias.EntityMedia", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("Id");
                    ...
                    b.ToTable("CmsKitEntityMedia", (string)null);
                });

            modelBuilder.Entity("FS.CmsKit.EntityMedias.EntityMediaGroup", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("Id");
                    ...
                    b.Property<Guid>("EntityMediaId")
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("EntityMediaId");
                    ...
                    b.HasIndex("EntityMediaId");

                    b.ToTable("CmsKitEntityMediaGroups", (string)null);
                });

            modelBuilder.Entity("FS.CmsKit.EntityMedias.EntityMediaItem", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("Id");
                    ...
                    b.Property<string>("EntityMediaGroupName")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("EntityMediaGroupName");
                    ...
                    b.ToTable("CmsKitEntityMediaItems", (string)null);
                });

            modelBuilder.Entity("FS.CmsKitManagement.Attachments.Attachment", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("Id");
                    ...
                    b.ToTable("CmsKitAttachments", (string)null);
                });

            modelBuilder.Entity("FS.CmsKitManagement.ContentRecords.ContentPartFieldRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("Id");

                    b.Property<Guid>("ContentPartRecordId")
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("ContentPartRecordId");
                    ...
                    b.HasIndex("ContentPartRecordId");

                    b.ToTable("CmsKitContentPartFieldRecords", (string)null);
                });

            modelBuilder.Entity("FS.CmsKitManagement.ContentRecords.ContentPartRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("Id");
                    ...
                    b.Property<Guid>("ContentTypeRecordId")
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("ContentTypeRecordId");
                    ...
                    b.HasIndex("ContentTypeRecordId");

                    b.ToTable("CmsKitContentPartRecords", (string)null);
                });

            modelBuilder.Entity("FS.CmsKitManagement.ContentRecords.ContentTypeRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("Id");
                    ...
                    b.ToTable("CmsKitContentTypeRecords", (string)null);
                });
            ...
            modelBuilder.Entity("FS.CmsKit.ContentComposites.AttachmentComposite", b =>
                {
                    b.HasBaseType("FS.CmsKit.ContentComposites.ContentComponent");

                    b.Property<string>("LimitFileSize")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("LimitFileSize");

                    b.Property<string>("LimitFileType")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("LimitFileType");

                    b.HasDiscriminator().HasValue("AttachmentComposite");
                });

            modelBuilder.Entity("FS.CmsKit.ContentComposites.ContentComposite", b =>
                {
                    b.HasBaseType("FS.CmsKit.ContentComposites.ContentComponent");

                    b.HasDiscriminator().HasValue("ContentComposite");
                });

            modelBuilder.Entity("FS.CmsKit.ContentComposites.ContentItem", b =>
                {
                    b.HasBaseType("FS.CmsKit.ContentComposites.ContentComponent");
            ...
            modelBuilder.Entity("FS.CmsKit.ContentComposites.ImageComposite", b =>
                {
                    b.HasBaseType("FS.CmsKit.ContentComposites.ContentComponent");
                    ...
                    b.HasDiscriminator().HasValue("ImageComposite");
                });
            ...
            modelBuilder.Entity("FS.CmsKit.ContentComposites.ContentComponent", b =>
                {
                    b.HasOne("FS.CmsKit.ContentComposites.ContentComponent", "Parent")
                        .WithMany("Children")
                        .HasForeignKey("ParentId");
            ...
            modelBuilder.Entity("FS.CmsKit.ContentDefinitions.ContentPartDefinition", b =>
                {
                    b.HasOne("FS.CmsKit.ContentDefinitions.ContentDefinition", null)
                        .WithMany("ContentPartDefinitions")
                        .HasForeignKey("ContentDefinitionId");
                });

            modelBuilder.Entity("FS.CmsKit.ContentDefinitions.ContentPartFieldDefinition", b =>
                {
                    b.HasOne("FS.CmsKit.ContentDefinitions.ContentPartDefinition", null)
                        .WithMany("ContentPartFieldDefinitions")
                        .HasForeignKey("ContentPartDefinitionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("FS.CmsKit.ContentDefinitions.ContentTypeDefinition", b =>
                {
                    b.HasOne("FS.CmsKit.ContentDefinitions.ContentDefinition", null)
                        .WithMany("ContentTypeDefinitions")
                        .HasForeignKey("ContentDefinitionId");
                });

            modelBuilder.Entity("FS.CmsKit.ContentDefinitions.ContentTypePartDefinition", b =>
                {
                    b.HasOne("FS.CmsKit.ContentDefinitions.ContentTypeDefinition", null)
                        .WithMany("ContentTypePartDefinitions")
            ...
            modelBuilder.Entity("FS.CmsKit.EntityMedias.EntityMediaGroup", b =>
                {
                    b.HasOne("FS.CmsKit.EntityMedias.EntityMedia", "EntityMedia")
                        .WithMany("EntityMediaGroups")
                        .HasForeignKey("EntityMediaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("FS.CmsKitManagement.ContentRecords.ContentPartFieldRecord", b =>
                {
                    b.HasOne("FS.CmsKitManagement.ContentRecords.ContentPartRecord", null)
                        .WithMany("ContentPartFieldRecords")
                        .HasForeignKey("ContentPartRecordId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("FS.CmsKitManagement.ContentRecords.ContentPartRecord", b =>
                {
                    b.HasOne("FS.CmsKitManagement.ContentRecords.ContentTypeRecord", null)
                        .WithMany("ContentPartRecords")
                        .HasForeignKey("ContentTypeRecordId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("FS.CmsKit.ContentDefinitions.ContentDefinition", b =>
                {
                    b.Navigation("ContentPartDefinitions");

                    b.Navigation("ContentTypeDefinitions");
                });

            modelBuilder.Entity("FS.CmsKit.ContentDefinitions.ContentPartDefinition", b =>
                {
                    b.Navigation("ContentPartFieldDefinitions");
                });

            modelBuilder.Entity("FS.CmsKit.ContentDefinitions.ContentTypeDefinition", b =>
                {
                    b.Navigation("ContentTypePartDefinitions");
                });

            modelBuilder.Entity("FS.CmsKit.EntityMedias.EntityMedia", b =>
                {
                    b.Navigation("EntityMediaGroups");
                });

            modelBuilder.Entity("FS.CmsKitManagement.ContentRecords.ContentPartRecord", b =>
                {
                    b.Navigation("ContentPartFieldRecords");
                });

            modelBuilder.Entity("FS.CmsKitManagement.ContentRecords.ContentTypeRecord", b =>
                {
                    b.Navigation("ContentPartRecords");
                });
