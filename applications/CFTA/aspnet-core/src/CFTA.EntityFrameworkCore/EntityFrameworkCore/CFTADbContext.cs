...
public class CFTADbContext :
    AbpDbContext<CFTADbContext>,
    ...
    ISaasDbContext
{
    ...
    public CFTADbContext(DbContextOptions<CFTADbContext> options)
        : base(options)
    {
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        //{
        //    b.ToTable(CFTAConsts.DbTablePrefix + "YourEntities", CFTAConsts.DbSchema);
