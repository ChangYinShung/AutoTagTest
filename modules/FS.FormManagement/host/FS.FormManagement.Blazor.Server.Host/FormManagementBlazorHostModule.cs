...
using FS.FormManagement.Blazor.Server.Host.Menus;
...
[DependsOn(
    ...
    typeof(FormManagementBlazorServerModule)
)]
public class FormManagementBlazorHostModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        context.Services.PreConfigure<AbpMvcDataAnnotationsLocalizationOptions>(options =>
        {
            options.AddAssemblyResource(
                ...
                typeof(FormManagementDomainModule).Assembly,
                typeof(FormManagementDomainSharedModule).Assembly,
                typeof(FormManagementApplicationModule).Assembly,
                typeof(FormManagementApplicationContractsModule).Assembly,
                typeof(FormManagementBlazorHostModule).Assembly
            );
        });
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        Configure<AbpBundlingOptions>(options =>
        {
                ...
                bundle =>
                {
                    bundle.AddFiles("/blazor-global-styles.css");
                        ...
                        bundle.AddFiles("/FS.FormManagement.Blazor.Server.Host.styles.css");
                }
            );
        });
        ...
        if (hostingEnvironment.IsDevelopment())
        {
            Configure<AbpVirtualFileSystemOptions>(options =>
            {
                ...
                options.FileSets.ReplaceEmbeddedByPhysical<FormManagementBlazorHostModule>(hostingEnvironment.ContentRootPath);
            });
        }
        ...
        {
            options.AppAssembly = typeof(FormManagementBlazorHostModule).Assembly;
        });
