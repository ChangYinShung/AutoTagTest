...
{
    [ReplaceDbContext(typeof(FS.FormManagement.EntityForms.EntityFrameworkCore.IEntityFormsDbContext))]
    ...
    public partial class FormManagementDbContext : AbpDbContext<FormManagementDbContext>, IFormManagementDbContext
    {
        ...
        public virtual DbSet<FS.FormManagement.EntityForms.EntityForm> EntityForms
        {
            get;
            set;
        }
