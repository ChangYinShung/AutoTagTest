...
namespace Volo.CmsKit.Admin.Blogs
{
    ...
    public class FSBlogPostAdminAppService : CmsKitAppServiceBase, IBlogPostAdminAppService
    {
        ...
        public FSBlogPostAdminAppService(
        ...
        public virtual async Task<PagedResultDto<BlogPostListDto>> GetListAsync(BlogPostGetListInput input)
        {
            ...
            var count = await BlogPostRepository.GetCountAsync(input.Filter, input.BlogId);
