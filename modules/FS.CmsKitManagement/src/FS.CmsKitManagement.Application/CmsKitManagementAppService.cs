...
namespace FS.CmsKitManagement
{
    public abstract class CmsKitManagementAppService : ApplicationService
    {
        ...
        protected FS.CmsKitManagement.Attachments.IAttachmentsStore MediaDescriptorsStore => this.LazyServiceProvider.LazyGetRequiredService<FS.CmsKitManagement.Attachments.IAttachmentsStore>();
