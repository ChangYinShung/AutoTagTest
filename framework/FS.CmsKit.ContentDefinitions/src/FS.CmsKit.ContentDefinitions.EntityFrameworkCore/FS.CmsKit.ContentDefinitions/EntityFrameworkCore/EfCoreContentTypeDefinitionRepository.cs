...
{
    public partial class EfCoreContentTypeDefinitionRepository 
    {
        public async Task PatchAsync(ContentTypeDefinition entity, bool autoSave = false, CancellationToken cancellationToken = default(CancellationToken))
        {
