...
namespace FS.Entity.MultiLinguals
{
        ...
        Volo.Abp.MultiTenancy.IMultiTenant
    {
        ...
        public MultiLingual()
        {
            this.MultiLingualTranslations = new List<MultiLingualTranslation>();
            OnCreated();
        }

        public MultiLingual(System.Guid id) : this()
        {
            this.Id = id;
        }
        ...
        public virtual IList<MultiLingualTranslation> MultiLingualTranslations
        {
            get;
            set;
        }
